...
import { Sprout, Lock, Mail, Eye, EyeOff, Github } from 'lucide-react';
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-emerald-100 font-light">
              Access premium farming insights, sustainable practices, and organic marketplace
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-zinc-50 text-zinc-500">or continue with email</span>
              </div>
            </div>
