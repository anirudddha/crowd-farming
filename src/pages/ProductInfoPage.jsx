...
const ProductPage = () => {
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      // If backend returns a 201 status, alert the user to sign in before submitting review
        ...
        <div className="bg-white rounded-3xl shadow-xl p-12">
                ...
                <div key={index} className="p-6 bg-green-50 rounded-xl">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-gray-800">{review.username || 'Unknown'}</span>
                    </div>
          ...
          <div>
            <button
              ...
              className="mb-4 py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            >
